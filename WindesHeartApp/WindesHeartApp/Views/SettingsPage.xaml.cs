...
namespace WindesHeartApp.Pages
{
    ...
    public partial class SettingsPage : ContentPage, IAnimationPage
    {
        ...
        private void BuildPage()
        {
            ...
            Button ToggleFormatButton = PageBuilder.AddButton(absoluteLayout, "Toggle 12/24H", Globals.SettingsPageViewModel.ToggleDisplayFormatsClicked, 0.05, 0.35, 0.45, 0.07, 10, 10, AbsoluteLayoutFlags.All, Globals.SecondaryColor);
            Button ToggleWristActivation = PageBuilder.AddButton(absoluteLayout, "Toggle wristactivation", Globals.SettingsPageViewModel.ToggleWristActivatedClicked, 0.95, 0.35, 0.45, 0.07, 10, 10, AbsoluteLayoutFlags.All, Globals.SecondaryColor);
